...
<html>
    ...
    <body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
      ...
      <ul class="tab-group">
        ...
        %>
        <li class="tab"><input type="submit" name="<%= classid+"_"+classDet %>" value="<%= sub+"_"+classDet %>"/></li>
        <%
                out.print("<br/><br/>");
            }
            rs.close();
       ...
       <div class="">
        <div id="signup">   	
            ...
            <% 
                        ...
                        String Class=ButtonID.split("_")[1];
                        out.print(Class);
                        session.setAttribute("classDetails", ButtonID);
